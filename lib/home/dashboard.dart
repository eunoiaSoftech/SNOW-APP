...
class _SnowDashboardState extends State<SnowDashboard> {
  ...
  // For matte press animation on quick action buttons
      ...
      child: ClipRRect(
        ...
        child: BackdropFilter(
          ...
          child: Container(
            ...
            height: actions.length <= 3 ? 180 : 320,
                ...
                GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return _quickActionButton(
                      ...
                      icon: item['icon'],
                      label: item['label'],
                      onTap: item['handler'] as VoidCallback,
                    );
                  },
                ),
              ],
  ...
  Widget _quickActionButton({
    ...
    final isPressed = _isPressed[index] ?? false;
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: Icon(icon, size: 22, color: const Color(0xFF014576)),
                  ),
